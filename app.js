(() => {
  ...
  const UPGRADE_CONFIG = {
    ...
    u13: { cost: 3000000, name: "Mega Dividends", effect: "Increase dividend rate by 25%", type: "dividend_rate", requires: "u10", effects: { dividend_rate: 0.25 } },
    ...
    u31: { cost: 150000000, name: "Strong Credit Score", effect: "Increases interest rate by 10%", type: "interest", requires: "u11", effects: { interest_rate: 0.10 } },
    ...
    u35: { cost: 1250000, name: "Property Management", effect: "Increases rent income from properties by 10%", type: "rent_boost", effects: { rent_income: 0.10 } },
