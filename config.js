...
const GAME_CONFIG = {
  ...
  UPGRADE_CONFIG: {
    ...
    u26: { cost: 1000000000000, name: "Prestige Reset", effect: "Reset everything for permanent +15% property and click multipliers", type: "prestige" },
    ...
    u112: { cost: 10000000000000, name: "Click Amplifier", effect: "Triples click income", type: "click_multiplier", effects: { click_multiplier: 2.0 } },
    u113: { cost: 100000000000000, name: "Bigger Clicks", effect: "Quadruples click income", type: "click_multiplier", effects: { click_multiplier: 3.0 } },
    u114: { cost: 3500000000000000, name: "Better Clicks", effect: "Quadruples click income", type: "click_multiplier", effects: { click_multiplier: 3.0 } },
    u115: { cost: 10000000000000000, name: "Best Clicks", effect: "Quadruples click income", type: "click_multiplier", effects: { click_multiplier: 3.0 } },
    u116: { cost: 50000000000000000, name: "Bash it like there is no tomorrow!", effect: "5x click income", type: "click_multiplier", effects: { click_multiplier: 4.0 } },
    u117: { cost: 175000000000000000, name: "Finger Bender!", effect: "5x click income", type: "click_multiplier", effects: { click_multiplier: 4.0 } },
    u118: { cost: 750000000000000000, name: "We can't stop!", effect: "10x click income", type: "click_multiplier", effects: { click_multiplier: 9.0 } },
    u119: { cost: 1500000000000000000, name: "We won't stop!", effect: "20x click income", type: "click_multiplier", effects: { click_multiplier: 19.0 } },
    u120: { cost: 6500000000000000000, name: "Click Oddyssey", effect: "20x click income", type: "click_multiplier", effects: { click_multiplier: 19.0 } },
    u121: { cost: 75000000000000000000, name: "Benjamin Button", effect: "20x click income", type: "click_multiplier", effects: { click_multiplier: 19.0 } },
    // Building-specific 20x income upgrades (third tier)
    u122: { cost: 60000000000000000000000000000, name: "Gourmet Legend", effect: "20x the income of Food Stands", type: "property_rent_boost", effects: { property_rent_income: 19.0 }, property: "foodStand" },
    u123: { cost: 96000000000000000000000000000, name: "Media Legend", effect: "20x the income of Newsstands", type: "property_rent_boost", effects: { property_rent_income: 19.0 }, property: "newsstand" },
    u124: { cost: 153600000000000000000000000000, name: "Parking Legend", effect: "20x the income of Parking Garages", type: "property_rent_boost", effects: { property_rent_income: 19.0 }, property: "parkingGarage" },
    u125: { cost: 245760000000000000000000000000, name: "Retail Legend", effect: "20x the income of Convenience Stores", type: "property_rent_boost", effects: { property_rent_income: 19.0 }, property: "convenienceStore" },
    u126: { cost: 393216000000000000000000000000, name: "Housing Legend", effect: "20x the income of Apartments", type: "property_rent_boost", effects: { property_rent_income: 19.0 }, property: "apartment" },
    u127: { cost: 629145600000000000000000000000, name: "Industrial Legend", effect: "20x the income of Manufacturing Plants", type: "property_rent_boost", effects: { property_rent_income: 19.0 }, property: "manufacturingPlant" },
