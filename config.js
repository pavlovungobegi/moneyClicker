...
const GAME_CONFIG = {
  ...
  UPGRADE_CONFIG: {
    ...
    // Late-game 8x income upgrades
    u62: { cost: 1000000000000, name: "Gourmet Revolution", effect: "8x the income of Food Stands", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "foodStand" },
    u63: { cost: 3000000000000, name: "Digital Media Empire", effect: "8x the income of Newsstands", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "newsstand" },
    u64: { cost: 9000000000000, name: "Smart Parking Network", effect: "8x the income of Parking Garages", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "parkingGarage" },
    u65: { cost: 27000000000000, name: "24/7 Mega Mart", effect: "8x the income of Convenience Stores", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "convenienceStore" },
    u66: { cost: 81000000000000, name: "Luxury Residences", effect: "8x the income of Apartments", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "apartment" },
    u67: { cost: 243000000000000, name: "AI Manufacturing", effect: "8x the income of Manufacturing Plants", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "manufacturingPlant" },
    u68: { cost: 729000000000000, name: "Corporate Headquarters", effect: "8x the income of Office Buildings", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "officeBuilding" },
    u69: { cost: 2187000000000000, name: "Vertical Metropolis", effect: "8x the income of Skyscrapers", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "skyscraper" },
    u70: { cost: 6561000000000000, name: "Grand Opera Dynasty", effect: "8x the income of Opera Houses", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "operaHouse" },
    // Second tier late-game 8x income upgrades
    u71: { cost: 75000000000000000, name: "Media Empire Expansion", effect: "8x the income of Newsstands", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "newsstand" },
    u72: { cost: 25000000000000000, name: "Gourmet Food Revolution", effect: "8x the income of Food Stands", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "foodStand" },
    u73: { cost: 225000000000000000, name: "Smart City Parking", effect: "8x the income of Parking Garages", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "parkingGarage" },
    u74: { cost: 675000000000000000, name: "Mega Retail Chains", effect: "8x the income of Convenience Stores", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "convenienceStore" },
    u75: { cost: 2025000000000000000, name: "Premium Living Spaces", effect: "8x the income of Apartments", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "apartment" },
    u76: { cost: 6075000000000000000, name: "Automated Production Lines", effect: "8x the income of Manufacturing Plants", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "manufacturingPlant" },
    u77: { cost: 18225000000000000000, name: "Global Corporate Centers", effect: "8x the income of Office Buildings", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "officeBuilding" },
    u78: { cost: 54675000000000000000, name: "Sky City Networks", effect: "8x the income of Skyscrapers", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "skyscraper" },
    u79: { cost: 164025000000000000000, name: "Cultural Capital Empire", effect: "8x the income of Opera Houses", type: "property_rent_boost", effects: { property_rent_income: 7.0 }, property: "operaHouse" },
